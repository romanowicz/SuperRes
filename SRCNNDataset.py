...
class SRCNNDataset(Dataset):
    ...
    def __init__(self, annotations_file, img_dir, max_images=None, tile_size=TILE_SIZE, stride=STRIDE, transform=None, target_transform=None):        
    ...
    def __getitem__(self, idx):
        ...
        tile_offs_x = tile_idx_x * self.stride
        tile_offs_y = tile_idx_y * self.stride
        bbox = (tile_offs_x, tile_offs_y, tile_offs_x + TILE_SIZE, tile_offs_y + self.tile_size)
